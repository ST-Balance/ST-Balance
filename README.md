...
Epidemics:
* The raw data originates from [CSSE](https://github.com/CSSEGISandData/COVID-19) and is processed within the BasicTS framework (see the Covid19 folder). We also use the [STSGT](https://github.com/soumbane/STSGT), [SAB‑GNN](https://github.com/soumbane/STSGT) and [EpiLearn](https://github.com/Emory-Melody/EpiLearn/tree/main/epilearn/models/SpatialTemporal) as the experimental baseline.
